...
Author: Dawson Pease
Date: 10/8/24
Info: Program finds statistical values of two given numbers using user-defined functions.
...
bool program() {
    ...
    switch(option) {
        ...
        {
            getTwoNumbers(num1, num2);
            double avrg = findaverage(num1, num2);
            printf("the average between %.2f & %.2f is %.2f\n", num1, num2, avrg);
            break;
